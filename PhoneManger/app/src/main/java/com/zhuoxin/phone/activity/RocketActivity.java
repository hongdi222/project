...
public class RocketActivity extends ActionBarActivity {
    ...
    private void initListView() {
        //4.0之前，可以通过ActivityMananger来获取运行中的进程。
        ...
        //4.0之后，获取不到运行的进程，并且，在5.0的时候，谷歌把权限也删除了

        adapter = new RocketAdapter(this, MemoryManager.getRunning(this));
